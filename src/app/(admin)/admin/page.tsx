...
export default async function AdminHomePage() {
  ...
  const canAccessAdmin =
    role === "SUPER_ADMIN" || role === "FOURNISSEUR" || role === "ADMIN" || role === "EMPLOYEE";
  if (!role || !canAccessAdmin) redirect("/quotes");
          ...
          {role === "SUPER_ADMIN" && (
            <Card>
              <CardHeader className="pb-3">
                ...
                <CardDescription>Utilisateurs et droits d&apos;accès</CardDescription>
              </CardHeader>
              <CardContent className="grid gap-2">
                ...
                >
                  ...
                  <div>
                    <p className="font-medium leading-none">Utilisateurs</p>
                    <p className="mt-0.5 text-xs text-muted-foreground">Créer et gérer Fournisseurs & Acheteurs</p>
                  </div>
                </Link>
                <Link
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-muted-foreground">Fournisseurs accessibles par Acheteur</p>
                  </div>
                </Link>
              </CardContent>
            </Card>
